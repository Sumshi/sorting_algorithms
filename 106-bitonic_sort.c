#include "sort.h"
/**
 * bitonic_swap - sort the values in a sub-array
 * @up: direction of sorting
 * @array: sub-array to sort
 * @size: size of the sub-array
 * Return: void
 */
void bitonic_swap(char up, int *array, size_t size)
{
	size_t i;
	size_t count;
	int temp;
...
/**
 * bitonic_merge - merges two sub-arrays
 * @up: direction of sorting
 * @array: sub-array to sort
 * @size: size of the sub-array
 * Return: void
